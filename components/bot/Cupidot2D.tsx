...
export function Cupidot2D({
  ...
  const loving = visualState === 'love' || visualState === 'happy' || visualState === 'celebration';
  ...
  return (
    <span
      ...
      style={{ '--cupidot-size': typeof size === 'number' ? `${size}px` : size, ...style } as React.CSSProperties}
    ...
    >
      ...
      <span className="cupidot-plush__actor" aria-hidden>
        <img className="cupidot-plush__art cupidot-plush__art--rest" src={CUPIDOT_ART} alt="" draggable={false} decoding="async" />
        {roam && (
          <span className="cupidot-plush__walk-cycle">
            <img className="cupidot-plush__art cupidot-plush__art--step-a" src={CUPIDOT_WALK_A} alt="" draggable={false} decoding="async" />
            <img className="cupidot-plush__art cupidot-plush__art--step-b" src={CUPIDOT_WALK_B} alt="" draggable={false} decoding="async" />
          </span>
        )}
      </span>
      {loving && <span className="cupidot-plush__effects" aria-hidden><i>♥</i><i>♥</i><i>✦</i></span>}
      {sleeping && <span className="cupidot-plush__sleep" aria-hidden>z</span>}
    </span>
  );
}
