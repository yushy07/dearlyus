  ...
  return (
    ...
    >
      <Ribbon
        text={
          <>
            📖 Dearly Us Stories &amp; Guides ·{' '}
            <b>Research, Advice &amp; Ideas for Long Distance Love</b>
          </>
        }
      />
        ...
        {!selectedPost ? (
          <>
            <div style={{ textAlign: 'center', marginBottom: '48px' }}>
              ...
              >
                Written by two people who spent two years in an LDR between
                Canada and Indonesia, plus researchers and couples in our
                community.
              </p>
            </div>
