                ...
                <ScrollReveal stagger animation="fade-up">
                  <div style={{ display: 'grid', gap: '10px' }}>
                    {[
                      ...
                      { num: '05', title: 'Couples Debate', desc: 'Playful courtroom debate on your fun relationship habits.' },
                      { num: '06', title: 'Honest Cards Deck', desc: 'Deep talk and intimate questions to melt the distance away.' },
                      { num: '07', title: 'Design Matching Outfits', desc: 'Compose custom matching couple outfits to wear on call.' },
                    ].map((item, i) => (
                      <div
                        key={i}
                        style={{
