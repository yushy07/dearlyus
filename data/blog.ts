...
export const BLOG_POSTS: Record<string, BlogPostData> = {
  'ldr-online-date-ideas': {
    ...
    content: [
      ...
      '1. The Synchronized Online Photobooth: Rather than taking another awkward screenshot, join Dearly Us’s photobooth. A shared 3..2..1 countdown snaps both of your webcams simultaneously, generating a classic Korean 인생네컷 4-cut photostrip you can stick to your real-life fridge.',
      ...
      '3. Double-Blind Couples Quiz: Use the Know Me Quiz on Dearly Us. The double-blind lock-in mechanism means neither person can peek until both hit lock-in, guaranteeing unfiltered authenticity.',
  ...
  'most-played-games': {
    ...
    content: [
      'Over 50,000 dates have been hosted on Dearly Us. Looking at the data, three activities consistently account for over 65% of all active time spent on the platform.',
  ...
  'photobooth-tutorial': {
    ...
    content: [
      'Traditional video call screenshots are blurry, awkward, and usually show one person looking away. Dearly Us’s online photobooth was engineered specifically to solve this problem.',
