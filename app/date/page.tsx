...
export default function DateNightPlannerPage() {
  ...
  const recipeSteps: RecipeStep[] = [
    {
      stepNum: 1,
      title: 'Prep Ingredients & Boil Water',
      durationSec: 180,
      instruction: `Fill pot with water, add 1 tbsp salt. ${partnerA} and ${partnerB} mince 3 cloves of garlic on camera together!`,
    },
    {
      stepNum: 2,
      title: 'Cook Pasta & Sizzle Garlic',
      durationSec: 480,
      instruction:
        'Drop pasta in boiling water. Sizzle garlic in olive oil on medium heat until fragrant.',
    },
    {
      stepNum: 3,
      title: 'Whisk Sauce & Combine',
      durationSec: 180,
      instruction:
        'Whisk 2 egg yolks with parmesan and black pepper. Toss hot drained pasta into the pan with sauce!',
    },
    {
      stepNum: 4,
      title: 'Plate, Pour Drinks & Rate Look',
      durationSec: 120,
      instruction: `Plate your dishes, hold them up to the webcam, and take a 4-cut photobooth victory strip!`,
    },
  ];
    ...
    >
      ...
      <Ribbon
        text={
          <>
            ...
            <b>
              Curated Schedules for {partnerA} &amp; {partnerB}
            </b>
          </>
        }
      />
      ...
      <main className="wrap" style={{ paddingTop: '36px', maxWidth: '920px' }}>
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          ...
          >
            Never Ask{' '}
            <span className="grad">&ldquo;What should we do?&rdquo;</span>{' '}
            Again.
          </h1>
          <p
            style={{
          ...
          >
            Parallel dining &amp; activities for{' '}
            <b>
              {partnerA} ({cityA})
            </b>{' '}
            and{' '}
            ...
            . Seamless itinerary of synced games, prompts, and photobooth
            milestones.
          </p>
        </div>
        ...
        >
          ...
          <button
            ...
            style={{
              padding: '10px 20px',
              borderRadius: '10px',
              background: cookingMode ? 'var(--pink)' : undefined,
              color: cookingMode ? '#fff' : undefined,
            }}
          >
        ...
        {!cookingMode ? (
          ...
          <div className="booth-box" style={{ padding: '32px 28px' }}>
            ...
            >
              <div>
                <span className="badge hot" style={{ marginBottom: '6px' }}>
                  {plan.mood}
                </span>
            ...
            >
              <div>
                ...
                >
                  {rainActive || fireActive
                    ? `Active Sound: ${rainActive ? 'Rain on Window 🌧️ ' : ''}${fireActive ? 'Fireplace 🔥' : ''}`
                    : 'No background sound (Click top bar to start)'}
                </div>
              </div>

              <Link
                className="btn btn-grad"
                href={plan.activities[0].href}
          ...
          <div className="booth-box" style={{ padding: '36px 32px' }}>
                    ...
                    style={{
                      ...
                      border:
                        selectedRecipe === r
                          ...
                          : '1px solid var(--line)',
                      background:
                        selectedRecipe === r ? 'var(--pink-tint)' : '#fff',
                      fontSize: '12px',
                      fontWeight: 700,
                    }}
                  >
            ...
            >
              ...
              >
                Step {recipeSteps[currentStepIdx].stepNum} of{' '}
                {recipeSteps.length}
              </span>
              <h3
                style={{
            ...
            >
              <span style={{ fontSize: '14px', color: 'var(--ink-soft)' }}>
                Done cooking? Hold your plates up to the webcam and snap a 4-cut
                victory strip!
              </span>
              <Link
                href="/photobooth"
