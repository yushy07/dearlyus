    ...
    >
      ...
      <Ribbon
        text={
          <>
            📖 Dearly Us Blog ·{' '}
            <b>Stories, Science &amp; Date Ideas for Long Distance Love</b>
          </>
        }
      />
      ...
      <main className="wrap" style={{ paddingTop: '40px', maxWidth: '780px' }}>
        ...
        <article
          className="booth-box"
          style={{ padding: '36px 32px', lineHeight: 1.8, fontSize: '16px' }}
        >
        ...
        <div style={{ marginTop: '36px' }}>
          <h3
            style={{ fontSize: '20px', fontWeight: 800, marginBottom: '16px' }}
          >
            Try These Activities from the Article
          </h3>
          <div
            style={{
              display: 'grid',
