...
function GoogleMark() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path fill="#FBBC05" d="M6.39 13.93A6.02 6.02 0 0 1 6.07 12c0-.67.12-1.32.32-1.93V7.44H3.04A10 10 0 0 0 2 12c0 1.61.39 3.14 1.04 4.56l3.35-2.63Z" />
    ...
    <main className={styles.page}>
        ...
        <Link className="brand" href="/" aria-label="Dearly Us home">
          <span className="brand-emblem" aria-hidden="true">
            <svg width="28" height="28" viewBox="0 0 128 128" fill="none">
              ...
              <path d="M64 77C51 93 29 86 29 64C29 45 48 38 64 58" stroke="#FF4E78" strokeWidth="12" strokeLinecap="round" />
              <path d="M64 58C80 38 99 45 99 64C99 86 77 93 64 77" stroke="#437EEB" strokeWidth="12" strokeLinecap="round" />
            </svg>
          </span>
          <span>Dearly Us</span>
        </Link>
      ...
      <section className={styles.stage}>
        <div className={styles.card}>
          ...
          <p className={styles.copy}>Save your space, invite your person, and pick up the little moments right where you left them.</p>
          {error && <div className={styles.error} role="alert">{error}</div>}
          <button className={styles.googleButton} onClick={continueWithGoogle} disabled={busy}>
            <GoogleMark /> {busy ? 'Checking your space…' : 'Continue with Google'}
          </button>
          <p className={styles.finePrint}>
            We only use your Google account to create and protect your Dearly Us profile. By continuing, you agree to our <Link href="/terms">Terms</Link> and acknowledge our <Link href="/privacy">Privacy Policy</Link>.
          </p>
        </div>
      </section>
    </main>
